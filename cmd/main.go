...
import (
	...
	armadaaiv1 "github.com/armada/configbundle/api/v1"
	"github.com/armada/configbundle/internal/controller"
...
func init() {
	...
	utilruntime.Must(armadaaiv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "15783de7.armada.ai",
	...
	if err := (&controller.ConfigBundleReconciler{
